...
NotebookDataLength[     77926,       1540]
NotebookOptionsPosition[     51797,        972]
NotebookOutlinePosition[     78049,       1533]
CellTagsIndexPosition[     77938,       1527]
WindowTitle->Paper-Folding an Ellipse
WindowFrame->Normal*)
...
Cell["Paper-Folding an Ellipse", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`n$$ = 30, $CellContext`p$$ = {-0.5, 0.6}, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`p$$], {-0.5, 0.6}}, Automatic}, {{
       Hold[$CellContext`n$$], 30, "folds"}, 10, 100, 10}}, Typeset`size$$ = {
    550., {204., 209.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`n$324348$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`n$$ = 30, $CellContext`p$$ = {-0.5, 0.6}}, 
      "ControllerVariables" :> {
        Hold[$CellContext`n$$, $CellContext`n$324348$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      DynamicModule[{$CellContext`r = 
         If[Norm[$CellContext`p$$] < 
           1 - $CellContext`\[Epsilon], $CellContext`p$$, (
            1 - $CellContext`\[Epsilon]) Normalize[$CellContext`p$$]]}, 
        Quiet[
         $CellContext`seeFolding[$CellContext`r, 
          RandomReal[{0, 2 Pi}, $CellContext`n$$], Epilog -> {Black, 
            Point[$CellContext`r]}]]], 
      "Specifications" :> {{{$CellContext`p$$, {-0.5, 0.6}}, Automatic, 
         ControlType -> Locator}, {{$CellContext`n$$, 30, "folds"}, 10, 100, 
         10, Appearance -> "Labeled"}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{603., {252., 257.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({{$CellContext`\[Epsilon] = 
          1/1000000, $CellContext`seeFolding[
            Pattern[$CellContext`p, 
             Blank[]], 
            Pattern[$CellContext`directions, 
             Blank[List]]] := Graphics[{Gray, 
             Circle[{0, 0}, 1], Dashed, 
             
             Map[$CellContext`crease[$CellContext`p, #]& , \
$CellContext`directions]}, PlotRange -> {{-2, 2}, {-1.5, 1.5}}, ImageSize -> 
            550], $CellContext`seeFolding[
            Pattern[$CellContext`p, 
             Blank[]], 
            Pattern[$CellContext`directions, 
             Blank[List]], 
            Pattern[$CellContext`opts, 
             BlankNullSequence[]]] := Graphics[{Gray, 
             Circle[{0, 0}, 1], Dashed, 
             
             Map[$CellContext`crease[$CellContext`p, #]& , \
$CellContext`directions]}, $CellContext`opts, 
            PlotRange -> {{-2, 2}, {-1.5, 1.5}}, ImageSize -> 
            550], $CellContext`crease[
            Pattern[$CellContext`p, 
             Blank[]], 
            Pattern[$CellContext`\[Phi], 
             Blank[]]] := Module[{$CellContext`r = {
               Cos[$CellContext`\[Phi]], 
               
               Sin[$CellContext`\[Phi]]}, $CellContext`a = \
$CellContext`amplitude[$CellContext`p, $CellContext`\[Phi]], $CellContext`n}, \
$CellContext`n = {1, -1} Reverse[$CellContext`r]; Line[
              
              ReplaceAll[$CellContext`r (
                 1 - $CellContext`a) + $CellContext`t $CellContext`n, 
               $CellContext`intersections[$CellContext`\[Phi], \
$CellContext`a]]]], $CellContext`amplitude[
            Pattern[$CellContext`p, 
             Blank[]], 
            Pattern[$CellContext`\[Phi], 
             Blank[]]] := With[{$CellContext`s = {
               Cos[$CellContext`\[Phi]], 
               Sin[$CellContext`\[Phi]]}}, 
            0.5 (2 - Dot[$CellContext`p, $CellContext`s] - Sqrt[
             1 - Dot[$CellContext`p, $CellContext`p] + 
              Dot[$CellContext`p, $CellContext`s]^2])], \
$CellContext`intersections[
            ...
            Pattern[$CellContext`d, 
             Blank[]]] := Module[{$CellContext`r = {
               Cos[$CellContext`\[Phi]], 
               Sin[$CellContext`\[Phi]]}, $CellContext`n}, $CellContext`n = {
               1, -1} Reverse[$CellContext`r]; MapThread[FindRoot[
               Thread[{
                  Cos[$CellContext`u], 
                  
                  Sin[$CellContext`u]} == $CellContext`r (
                   1 - $CellContext`d) + $CellContext`t $CellContext`n], \
{$CellContext`u, #}, {$CellContext`t, #2}]& , {$CellContext`\[Phi] + {
                0.5 Pi, 1.5 Pi}, {-1, 1}}]]}; $CellContext`\[Epsilon] = 
         10^(-6)}; Typeset`initDone$$ = True); ReleaseHold[
       HoldComplete[{Null, Null, Null, Null, Null, $CellContext`amplitude[
           Pattern[$CellContext`p, 
            Blank[]], 
           Pattern[$CellContext`\[Phi], 
            Blank[]]] := With[{$CellContext`s = {
            ...
            Blank[]]] := Module[{$CellContext`r = {
              ...
              Thread[{
                 ...
                 Sin[$CellContext`u]} == $CellContext`r (
                  1 - $CellContext`d) + $CellContext`t $CellContext`n], \
{$CellContext`u, #}, {$CellContext`t, #2}]& , {$CellContext`\[Phi] + {
               0.5 Pi, 1.5 Pi}, {-1, 1}}]], $CellContext`crease[
           Pattern[$CellContext`p, 
            Blank[]], 
           Pattern[$CellContext`\[Phi], 
            Blank[]]] := Module[{$CellContext`r = {
...
$CellContext`n = {1, -1} Reverse[$CellContext`r]; Line[
             ...
             ReplaceAll[$CellContext`r (
                1 - $CellContext`a) + $CellContext`t $CellContext`n, 
              $CellContext`intersections[$CellContext`\[Phi], \
$CellContext`a]]]], $CellContext`seeFolding[
           Pattern[$CellContext`p, 
            Blank[]], 
           Pattern[$CellContext`directions, 
            Blank[List]], 
           Pattern[$CellContext`opts, 
            ...
            Map[$CellContext`crease[$CellContext`p, #]& , \
$CellContext`directions]}, $CellContext`opts, 
           PlotRange -> {{-2, 2}, {-1.5, 1.5}}, ImageSize -> 550]}]]; 
...
Cell["\<\
Start with a circle drawn on paper and mark a point inside it. Fold the \
circle so that the circumference touches the point. Make a firm crease. \
Repeat, using random folds. The creases form the envelope of an ellipse.\
\>", "ManipulateCaption"],
...
Cell["\<\
The locator represents the point inside the circle. You can move the locator \
and vary the number of creases.\
\>", "DetailNotes",
 CellID->74135289],
...
Cell[TextData[{
 "[1] D. Wells, ",
 StyleBox["The Penguin Dictionary of Curious and Interesting Geometry",
  FontSlant->"Italic"],
 ", London: Penguin, 1991."
}], "DetailNotes",
 CellID->119971577],
...
PaperFoldingAnEllipse&version=0007"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/PaperFoldingAnEllipse/\
PaperFoldingAnEllipse-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\[NonBreakingSpace]",
 ButtonBox["Borut Levart",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Borut+Levart"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Borut+Levart"]
}], "Author",
 FontColor->GrayLevel[0.6]],

Cell[TextData[{
 "\"",
 ButtonBox["Paper-Folding an Ellipse",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/PaperFoldingAnEllipse/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/PaperFoldingAnEllipse/"],
 "\"",
 "\[ParagraphSeparator]\[NonBreakingSpace]",
 ButtonBox["http://demonstrations.wolfram.com/PaperFoldingAnEllipse/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/PaperFoldingAnEllipse/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/PaperFoldingAnEllipse/"],
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[43450, 769, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[43711, 778, 719, 18, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[50975, 947, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 77653, 1516},
 {"Copyright", 77847, 1521}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[35880, 605, 7307, 156, 70, "Output",
 CellID->1453318581],
Cell[43190, 763, 257, 4, 70, "ManipulateCaption"],
Cell[43450, 769, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[43711, 778, 719, 18, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[44433, 798, 33, 0, 70, "DetailsSection"],
Cell[44469, 800, 160, 4, 70, "DetailNotes",
 CellID->74135289],
Cell[44632, 806, 52, 1, 70, "DetailNotes",
 CellID->737634308],
Cell[44687, 809, 197, 6, 70, "DetailNotes",
 CellID->119971577],
Cell[44887, 817, 4802, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[49692, 908, 45, 0, 70, "CitationSection"],
Cell[49740, 910, 327, 10, 70, "Author"],
Cell[50070, 922, 902, 23, 70, "Citations"],
Cell[50975, 947, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature oSafaXEl7LRRtvml4gyRC89V *)
