...
NotebookDataLength[     84755,       1706]
NotebookOptionsPosition[     58191,       1126]
NotebookOutlinePosition[     84467,       1687]
CellTagsIndexPosition[     84356,       1681]
WindowTitle->Plane Cross Sections of the Surface of a Cone
WindowFrame->Normal*)
...
Cell["Plane Cross Sections of the Surface of a Cone", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`a$$ = 0, $CellContext`boxed$$ = 
    False, $CellContext`d$$ = 0, $CellContext`osy$$ = True, Typeset`show$$ = 
    True, Typeset`bookmarkList$$ = {
    "\"degenerate conic: a point\"" :> {$CellContext`a$$ = 
       0., $CellContext`d$$ = 0}, 
     "\"degenerate conic: a straight line\"" :> {$CellContext`a$$ = -0.5, \
$CellContext`d$$ = 0}, 
     "\"degenerate conic: a pair of intersecting lines\"" :> \
{$CellContext`a$$ = -0.68, $CellContext`d$$ = 0}, 
     "\"elliptical cross\[Hyphen]section\"" :> {$CellContext`a$$ = -0.16, \
$CellContext`d$$ = 0.66}, 
     "\"hyperbolic cross\[Hyphen]section\"" :> {$CellContext`a$$ = -0.78, \
$CellContext`d$$ = 0.52}, 
     "\"parabolic cross\[Hyphen]section\"" :> {$CellContext`a$$ = -0.5, \
$CellContext`d$$ = 0.52}}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{
      Hold["plane shift"], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`d$$], 0, ""}, -2, 2, 0.02}, {
      Hold[""], Manipulate`Dump`ThisIsNotAControl}, {
      Hold["plane slope"], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`a$$], 0, ""}, -1, 1, 0.02}, {
      Hold[""], Manipulate`Dump`ThisIsNotAControl}, {
      Hold[""], Manipulate`Dump`ThisIsNotAControl}, {
      Hold["display axes"], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`osy$$], True, ""}, {True, False}}, {
      Hold[""], Manipulate`Dump`ThisIsNotAControl}, {
      Hold["display the bounding box"], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`boxed$$], False, ""}, {True, False}}}, 
    Typeset`size$$ = {400., {198., 202.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`d$1115294$$ = 0, $CellContext`a$1115295$$ = 
    0, $CellContext`osy$1115296$$ = False, $CellContext`boxed$1115297$$ = 
    False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`a$$ = 0, $CellContext`boxed$$ = 
        False, $CellContext`d$$ = 0, $CellContext`osy$$ = True}, 
      "ControllerVariables" :> {
        Hold[$CellContext`d$$, $CellContext`d$1115294$$, 0], 
        Hold[$CellContext`a$$, $CellContext`a$1115295$$, 0], 
        Hold[$CellContext`osy$$, $CellContext`osy$1115296$$, False], 
        Hold[$CellContext`boxed$$, $CellContext`boxed$1115297$$, False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         ...
         Graphics3D[{
           Opacity[0.8], 
           Cone[{{0, 0, -2.001}, {0, 0, 0}}, 2.001], 
           Cone[{{0, 0, 2.001}, {0, 0, 0}}, 2.001]}, 
          PlotRange -> {{-2, 2}, {-2, 2}, {-2, 2}}, Axes -> True], 
         ContourPlot3D[(-$CellContext`a$$) $CellContext`x + 
           0 $CellContext`y + (1 - 
             Abs[$CellContext`a$$]) $CellContext`z - $CellContext`d$$ == 
          0, {$CellContext`x, -2, 2}, {$CellContext`y, -2, 
           2}, {$CellContext`z, -2, 2}, Boxed -> False, BoundaryStyle -> None,
           ContourStyle -> Opacity[0.7, Yellow], MeshFunctions -> 
          Function[{$CellContext`x$, $CellContext`y$, $CellContext`z$}, \
(($CellContext`x$ + 0)^2 + ($CellContext`y$ + 0)^2 - (($CellContext`z$ + 0) 
              1)^2) - ((-$CellContext`a$$) $CellContext`x$ + 
            0 $CellContext`y$ + (1 - 
              Abs[$CellContext`a$$]) $CellContext`z$ - $CellContext`d$$)], 
          MeshStyle -> {{Thick, 
             Darker[Green, 0.5]}}, Mesh -> {{0}}, 
          PlotRange -> {{-2, 2}, {-2, 2}, {-2, 2}}, MaxRecursion -> 10]}, 
        Boxed -> $CellContext`boxed$$, Axes -> $CellContext`osy$$, 
        ImageSize -> {400, 400}, SphericalRegion -> True], 
      "Specifications" :> {
       "plane shift", {{$CellContext`d$$, 0, ""}, -2, 2, 0.02, Appearance -> 
         "Labeled", ImageSize -> Tiny}, "", 
        "plane slope", {{$CellContext`a$$, 0, ""}, -1, 1, 0.02, Appearance -> 
         "Labeled", ImageSize -> Tiny}, "", "", 
        "display axes", {{$CellContext`osy$$, True, ""}, {True, False}}, "", 
        "display the bounding box", {{$CellContext`boxed$$, False, ""}, {
         True, False}}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{575., {227., 232.}},
...
Cell["\<\
This is a simple Demonstration of the cross sections of the surface of a \
cone. It shows not only the nondegenerate conics, that is, the ellipse, the \
hyperbola, and the parabola, but also the degenerate conics (which are a \
single point), a straight line, and a pair of intersecting lines.\
\>", "ManipulateCaption",
 CellID->466465704],
...
Cell["\<\
See the Demonstrations in Related Links to easily find some interesting \
preset positions of the plane.\
\>", "DetailNotes",
 CellID->360144543],

Cell["For more theory see [1].", "DetailNotes",
 CellID->1058565503],
...
Cell[TextData[{
 "[1] Wikipedia. \"Conic Section.\" (Dec 31, 2013) ",
 ButtonBox["en.wikipedia.org/wiki/Conic_section",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://en.wikipedia.org/wiki/Conic_section"], None},
  ButtonNote->"http://en.wikipedia.org/wiki/Conic_section"],
 "."
}], "DetailNotes",
 CellID->537800564],
...
Cell[TextData[{
 ButtonBox["Conic Sections: The Double Cone",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ConicSectionsTheDoubleCone/"], 
    None},
  ButtonNote->"http://demonstrations.wolfram.com/ConicSectionsTheDoubleCone/"],
 " (",
...
Cell[TextData[{
 ButtonBox["Intersecting a Rotating Cone with a Plane",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
IntersectingARotatingConeWithAPlane/"], None},
  ButtonNote->
...
Cell[TextData[{
 ButtonBox["Plane Sections of Surfaces",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/PlaneSectionsOfSurfaces/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/PlaneSectionsOfSurfaces/"],
 " (",
 ButtonBox["Wolfram Demonstrations Project",
  BaseStyle->"SiteLink",
  ButtonData->{
...
PlaneCrossSectionsOfTheSurfaceOfACone&version=0007"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/PlaneCrossSectionsOfTheSurfaceOfACone/\
PlaneCrossSectionsOfTheSurfaceOfACone-source.nb"]], \
...
Cell[TextData[{
 "\[NonBreakingSpace]",
 ButtonBox["Petr Maixner",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Petr+Maixner"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Petr+Maixner"]
}], "Author",
 FontColor->GrayLevel[0.6]],

Cell[TextData[{
 "\"",
 ButtonBox["Plane Cross Sections of the Surface of a Cone",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
PlaneCrossSectionsOfTheSurfaceOfACone/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/PlaneCrossSectionsOfTheSurfaceOfACone/"],
 "\"",
 "\[ParagraphSeparator]\[NonBreakingSpace]",
 ButtonBox["http://demonstrations.wolfram.com/\
PlaneCrossSectionsOfTheSurfaceOfACone/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
PlaneCrossSectionsOfTheSurfaceOfACone/"], None},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[41175, 706, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[41436, 715, 6781, 147, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[57369, 1101, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 84068, 1670},
 {"Copyright", 84264, 1675}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1522, 34, 34328, 567, 70, "DemonstrationHeader"],
Cell[35853, 603, 66, 0, 70, "DemoTitle"],
Cell[35922, 605, 4897, 91, 70, "Output",
 CellID->232886752],
Cell[40822, 698, 350, 6, 70, "ManipulateCaption",
 CellID->466465704],
Cell[41175, 706, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[41436, 715, 6781, 147, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[48220, 864, 33, 0, 70, "DetailsSection"],
Cell[48256, 866, 155, 4, 70, "DetailNotes",
 CellID->360144543],
Cell[48414, 872, 68, 1, 70, "DetailNotes",
 CellID->1058565503],
Cell[48485, 875, 53, 1, 70, "DetailNotes",
 CellID->1555877173],
Cell[48541, 878, 328, 9, 70, "DetailNotes",
 CellID->537800564],
Cell[48872, 889, 44, 0, 70, "RelatedLinksSection"],
Cell[48919, 891, 628, 21, 70, "RelatedLinks",
 CellID->89997196],
Cell[49550, 914, 514, 15, 70, "RelatedLinks",
 CellID->326451718],
Cell[50067, 931, 543, 16, 70, "RelatedLinks",
 CellID->193931904],
Cell[50613, 949, 498, 14, 70, "RelatedLinks",
 CellID->229612183],
Cell[51114, 965, 4852, 90, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[55969, 1057, 45, 0, 70, "CitationSection"],
Cell[56017, 1059, 327, 10, 70, "Author"],
Cell[56347, 1071, 1019, 28, 70, "Citations"],
Cell[57369, 1101, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature FSa2IULFObi45xQTpM3I28fw *)
