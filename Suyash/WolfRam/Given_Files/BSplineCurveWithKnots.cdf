...
NotebookDataLength[     98347,       2092]
NotebookOptionsPosition[     70592,       1492]
NotebookOutlinePosition[     96847,       2053]
CellTagsIndexPosition[     96736,       2047]
WindowTitle->B-Spline Curve with Knots
WindowFrame->Normal*)
...
Cell["B-Spline Curve with Knots", "DemoTitle"],
...
Cell[TextData[{
 "This Demonstration illustrates the relation between B-spline curves and \
their knot vectors. Start with the control points ",
 Cell[BoxData[
  FormBox[
   RowBox[{"{", 
    RowBox[{
     ...
     RowBox[{
      SubscriptBox["p", "n"], "|", 
      RowBox[{
       SubscriptBox["p", "i"], "\[Element]", 
       SuperscriptBox["\[DoubleStruckCapitalR]", "k"]}]}]}], "}"}], 
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"p", "=", 
    RowBox[{"m", "-", "n", "-", "1"}]}], TraditionalForm]], "InlineMath"],
 ". The knot vector satisfies ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["t", "i"], "\[Element]", 
    RowBox[{"[", 
 ...
 FormBox[
  RowBox[{
   ...
   FormBox[
    ...
    TraditionalForm]}], TraditionalForm]], "InlineMath"]], "ManipulateCaption",
 CellID->366018374],
     ...
     RowBox[{
      ...
      RowBox[{
       SubscriptBox["N", 
        RowBox[{
         RowBox[{"i", "+", "1"}], ",", 
         RowBox[{"p", "-", "1"}]}]], "(", "t", ")"}]}]}]}], TraditionalForm]],
   "InlineMath"],
 ","
}], "ManipulateCaption",
 CellID->151409635],

Cell["and a B-spline curve is defined as:", "ManipulateCaption",
 CellID->185426259],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"p", "-", "k"}], TraditionalForm]], "InlineMath"],
 " times differentiable. So, by overlapping the knots, you can generate a \
curve with sharp turns or even discontinuities."
}], "ManipulateCaption",
 CellID->193507047],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"p", "-", "1"}], TraditionalForm]], "InlineMath"],
 ", the basis functions are reduced to Bernstein polynomial, thus the curve \
becomes a B\[EAcute]zier curve."
}], "ManipulateCaption",
 CellID->30642511],
...
Cell[TextData[{
 ...
 " on the curve. Hold down the Alt key and click to add new control points \
(up to 12). Changes in degree and number of control points will cause the \
knot vector to be recomputed."
}], "DetailNotes",
 CellID->475213764],

Cell["\<\
Choose \"view basis functions\" to show the B-spline basis functions of a \
given knot vector instead of the B-spline curve.\
\>", "DetailNotes",
 CellID->33956274],
...
Cell[TextData[{
 ButtonBox["Spline",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/Spline.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Internal Knots",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/InternalKnot.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
BSplineCurveWithKnots&version=0026"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/BSplineCurveWithKnots/\
BSplineCurveWithKnots-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["B-Spline Curve with Knots",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/BSplineCurveWithKnots/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/BSplineCurveWithKnots/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/BSplineCurveWithKnots/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/BSplineCurveWithKnots/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/BSplineCurveWithKnots/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[59017, 1184, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[59278, 1193, 1751, 42, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[69770, 1467, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 96447, 2036},
 {"Copyright", 96644, 2041}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[589, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34920, 590, 46, 0, 70, "DemoTitle"],
Cell[34969, 592, 19060, 420, 70, "Output",
 CellID->334701150],
Cell[54032, 1014, 1398, 45, 70, "ManipulateCaption"],
Cell[55433, 1061, 1033, 29, 70, "ManipulateCaption",
 CellID->366018374],
Cell[56469, 1092, 1041, 38, 70, "ManipulateCaption",
 CellID->151409635],
Cell[57513, 1132, 84, 1, 70, "ManipulateCaption",
 CellID->185426259],
Cell[57600, 1135, 408, 16, 70, "ManipulateCaption",
 CellID->79435196],
Cell[58011, 1153, 700, 19, 70, "ManipulateCaption",
 CellID->193507047],
Cell[58714, 1174, 300, 8, 70, "ManipulateCaption",
 CellID->30642511],
Cell[59017, 1184, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[59278, 1193, 1751, 42, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[61032, 1237, 33, 0, 70, "DetailsSection"],
Cell[61068, 1239, 396, 10, 70, "DetailNotes",
 CellID->475213764],
Cell[61467, 1251, 174, 4, 70, "DetailNotes",
 CellID->33956274],
Cell[61644, 1257, 44, 0, 70, "RelatedLinksSection"],
Cell[61691, 1259, 556, 20, 70, "RelatedLinks",
 CellID->110935412],
Cell[62250, 1281, 552, 20, 70, "RelatedLinks",
 CellID->650950033],
Cell[62805, 1303, 566, 20, 70, "RelatedLinks",
 CellID->393553989],
Cell[63374, 1325, 414, 13, 70, "RelatedLinks",
 CellID->142931639],
Cell[63791, 1340, 4802, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[68596, 1431, 45, 0, 70, "CitationSection"],
Cell[68644, 1433, 793, 20, 70, "Citations"],
Cell[69440, 1455, 327, 10, 70, "Author"],
Cell[69770, 1467, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature mRqlDhSLaow5axAFVHu48KfA *)
